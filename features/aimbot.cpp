...
void C_IWAimbot::Main(CUserCmd* pUserCmd, C_BasePlayer* pLocal, bool& bSendPacket)
{
	...
	if (iTarget > -1)
	{
		...
		{
			CalcAngle(vEyePos, vFinal, pUserCmd->viewangles); //Silent                                 uncomment this if need
